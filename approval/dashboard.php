                    ...
                    <div class="col s12 m12 l4">
                        <div class="card stats-card" style="background-color: #00B0F0!important;">
                            <div class="card-content">
                                ...
                                <span class="card-title">Total users in <?php echo $dept;?> </span>
                                <span class="stats-counter">
<?php

$sql = "SELECT id from tblemployees where tblemployees.department = '".$dept."'";
...
?>
    ...
    <?php
    $sql = "SELECT tblleaves.id from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.Status = '0' and tblemployees.department = '".$dept."'";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
                        ...
                        <div class="card stats-card" style="background-color:#FFE699;">
                            <div class="card-content">
                                <span class="card-title">Employees on leave</span>
									...
									$sql = "SELECT tblleaves.id from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.status = '1' and tblleaves.FromDate <= today and tblleaves.ToDate >= today and tblemployees.department = '".$dept."'";
