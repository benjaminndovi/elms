                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $dept=$_SESSION['dept']; $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status,tblleaves.Hr_Status from tblleaves join tblemployees on tblleaves.empid=tblemployees.id order by lid desc";
...
{         
      ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities(date("d F, Y H:i:s", strtotime($result->PostingDate)));?></td>
