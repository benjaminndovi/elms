...
$status=1;
$hr=1;
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status,tblleaves.Hr_Status from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.Status=:status and tblleaves.Hr_Status = '".$hr."' order by lid desc";
...
{         
      ?>  
                                        ...
                                        <tr>
											...
											<?php 
												$readableDate = date("d F, Y", strtotime($result->PostingDate));
											?>
                                            <td><?php echo htmlentities($readableDate);?></td>
