...
header("location: leavehistory.php");
  ...
  echo "<script>alert('Your account is inactive or does not exist');</script>";
        ...
        <div class="mn-content fixed-sidebar">
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding <?php 
						if(!isset($_GET['goto'])){
							echo ' active '; 
						}
					?>"><a class="waves-effect waves-grey" href="index.php"><i class="material-icons"></i>Home</a></li>
                    <li class="no-padding <?php
							if(isset($_GET['goto'])){
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons"></i>Emp Password Recovery</a></li>
					   ...
					   ?>"><a class="waves-effect waves-grey" href="index.php?goto=admin"><i class="material-icons"></i>Admin Login</a></li>

                </ul>
          <div class="footer">
                    <p class="copyright"><a ">&copy; 2021 | Aubrey</a></p>
                          ...
                          <div class="col s12 m6 l8 offset-l2 offset-m3">
                              <div class="card white darken-1">
									...
									if(isset($_GET['goto'])){
										...
										if($_GET['goto']=='admin'){
											echo "<div class=\"card-content \" style=\"background-color: #bcf99f! important;\">
										...
										}else if($_GET['goto']=='emp'){
											echo "<div class=\"card-content \" style=\"background-color: #bcf99f! important;\">
											<span class=\"card-title\" style=\"font-size:20px;\">Employee Login</span>
											   <div class=\"row\">
											   <form class=\"col s12\" name=\"employeeSignIn\" method=\"post\">
											   <div class=\"input-field col s12\">
											   <input id=\"username\" type=\"text\" name=\"username\" class=\"validate\" autocomplete=\"off\" required >
											   ...
											   <input type=\"submit\" name=\"employeeSignIn\" value=\"Sign in\" class=\"waves-effect waves-light btn teal\">
											   </div>
											   </form>
											  </div>
											</div>";
