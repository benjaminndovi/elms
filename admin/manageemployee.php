                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT EmpId,FirstName,LastName,Department,Status,RegDate,id, Position from  tblemployees";
$query = $dbh -> prepare($sql);
$query->execute();
...
{               ?>  
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->Department)."<br>".
												htmlentities($result->Position);
											?></td>
