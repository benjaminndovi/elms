...
<input  disabled='true' name="empcode" id="empcode" value="<?php echo htmlentities($result->EmpId);?>" type="text" autocomplete="off" readonly required>
...
<input type='text' value="<?php echo htmlentities($result->Department);?>" disabled='true'/>
</div>
<div class="input-field col m6 s12">
